"""
Django settings for infodisclosure_backend project.
...
SECRET_KEY = 'django-insecure-o7rc9^^*$sn04azxh2d%7#f0ec$$)7pwp#g4*)51cdwd3sd=7k'
...
WSGI_APPLICATION = 'infodisclosure_backend.wsgi.application'
